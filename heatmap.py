...
class yolov8_heatmap:
    ...
    def __call__(self, img_path, save_path):
        ...
        if os.path.isdir(img_path):
            ...
            self.process(img_path, f'{save_path}/02172_12_18.png')
        
def get_params():
    params = {
        'weight': 'runs/train_fire/exp114/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'XGradCAM', # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM
        'layer': [10,18],#[10, 12, 14, 16, 18],
...
if __name__ == '__main__':
    ...
    # model(r'D:/Experiment/TestDatasets/fire1-normal-label1/images/val/02172.jpg', 'D:/Experiment/FireEnhancement/Results/Datasets/Fire-Map3')
    # model(r'D:/Experiment/FireEnhancement/Results/Ours/fire1-normal-fusion-label1/images/test/fire4_02396.jpg', 'D:/Experiment/FireEnhancement/Results/Ours/Fire-Map')
    model(r'D:/Experiment/FireEnhancement/Results/SLP/fire1-normal-label1/images/val/02172.jpg', 'D:/Experiment/FireEnhancement/Results/SLP/Fire-Map3')