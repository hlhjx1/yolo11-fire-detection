...
pwd = os.getcwd()
names = ['yolov11', 'v11+DCP', 'v11+DHM', 'v11+LIME', 'v11+NLD', 'v11+PCA', 'v11+PPRM', 'v11+RRM', 'v11+SLP', 'CoDeF-Net']
...
plt.tight_layout()
plt.savefig('metrice_curve_enh.png')
print(f'metrice_curve.png saved in {pwd}/metrice_curve_enh.png')
...
plt.tight_layout()
plt.savefig('loss_curve_enh.png')
print(f'loss_curve.png saved in {pwd}/loss_curve_enh.png')
